...
class StorageDashboardService {
  ...
  async getRealTimeStorageData(): Promise<RealTimeStorageData> {
    try {
      const storageStats = await electronBridge.getStorageStats();
  ...
  async getRealTimeSyncData(): Promise<RealTimeSyncData> {
    try {
      const syncStats = await electronBridge.getSyncStats();
  ...
  async getRealTimeFileData(): Promise<FileCategoryData> {
    try {
      return await electronBridge.getFileStats();
    } catch (error) {
  ...
  async preloadFrequentData(): Promise<void> {
    try {
      await electronBridge.forceSync(); // Utilise la vraie synchronisation
  ...
  async forceSync(): Promise<void> {
    try {
      await electronBridge.forceSync();
  ...
  async getSyncQueue(): Promise<any[]> {
    try {
      return await electronBridge.getSyncQueue();
    } catch (error) {
  ...
  async clearCache(): Promise<void> {
    try {
      await electronBridge.clearCache();
  ...
  async analyzeDiskSpace(): Promise<any> {
    try {
      return await electronBridge.analyzeDiskSpace();
    } catch (error) {
  ...
  async cleanupOldFiles(): Promise<void> {
    try {
      await electronBridge.cleanupOldFiles();
  ...
  async checkIntegrity(): Promise<any> {
    try {
      return await electronBridge.checkIntegrity();
    } catch (error) {
  ...
  async exportMetrics(): Promise<any> {
    try {
      return await electronBridge.exportMetrics();
    } catch (error) {
  ...
  async cleanupLogs(): Promise<void> {
    try {
      await electronBridge.cleanupLogs();
  ...
  async getAdvancedSettings(): Promise<any> {
    try {
      return await electronBridge.getAdvancedSettings();
    } catch (error) {
