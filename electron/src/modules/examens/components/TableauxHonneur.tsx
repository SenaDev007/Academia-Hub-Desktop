...
export function TableauxHonneur() {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      let content = `TABLEAU D'HONNEUR - ${selectedTrimester}\n\n`;
      ...
      link.href = url;
      link.download = `Tableau_Honneur_${selectedCategory}_${selectedTrimester}.txt`;
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-yellow-50 to-orange-50">
            <h3 className="text-xl font-bold text-gray-900 flex items-center">
              ...
              Classement Général - {selectedTrimester}
            </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="text-sm text-blue-800 space-y-1">
              ...
              <p>Trimestre: {selectedTrimester}</p>
      ...
      {showNotifications && (
        <NotificationPanel
          ...
          context={{
            ...
            data: { trimestre_id: selectedTrimester, classe_id: selectedClass }
          }}
        />
      )}
    </div>
